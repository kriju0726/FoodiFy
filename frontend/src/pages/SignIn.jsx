  ...
  return (
    ...
    style= {{backgroundColor: bgColor}}>
        <div className={`bg-white rounded-xl shadow-lg w-full max-w-md p-8 border-[1px]`} 
            ...
            <p className='text-gray-600 mb-8'> SignIn to your account to get started with delicius
                food deliveries
            </p>  
            ...
            <div className="text-right mt-2 mb-0 text-[#ff4d2d] font-medium cursor-pointer" 
            ...
            <button type="button" className={`w-full font-semibold py-2 mt-3 rounded-lg transition duration-200
             bg-[#ff4d2d] text-white hover:bg-[#d43818] cursor-pointer`} onClick={handleSignIn} disabled={loading}> 
