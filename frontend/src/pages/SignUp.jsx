  ...
  return (
    ...
    style= {{backgroundColor: bgColor}}>
        <div className={`bg-white rounded-xl shadow-lg w-full max-w-md p-8 border-[1px]`} 
            ...
            <p className='text-gray-600 mb-8'> Create your account to get started with delicius food deliveries</p>
            ...
            {/* role */}
            <div className='relative'>
                <label htmlFor="role" className='block text-gray-700 font-medium mb-1'>Role
                </label>
            ...
            <button type="button" className={`w-full font-semibold py-2 mt-3 rounded-lg transition duration-200
             bg-[#ff4d2d] text-white hover:bg-[#d43818] cursor-pointer`} onClick={handleSignUp} disabled={loading}> 
             { loading ? <ClipLoader size={20} color='white'/> : 'Sign Up' }
            </button>
            {err && <p className='text-red-500 text-center my-[10px]'>*{err}</p>}

             <button className='w-full mt-4 flex items-center justify-center gap-2 border rounded-lg px-4 py-2
                transition duration-200 border-gray-200 hover:bg-gray-300 cursor-pointer' onClick={handleGoogleAuth}>
