  ...
  return (
    ...
    fixed top-0 z-[9999] bg-[#fff9f6] overflow-visible'>
        ...
        <div className='flex items-center gap-4'>
            {showSearch ? <RxCross2 size={22} className='text-[#ff4d2d] md:hidden' onClick={ () => setShowSearch(false) }/> 
        ...
        { showInfo && <div className='fixed top-[80px] right-[10px] md:right-[10%] lg:right-[25%] w-[180px] bg-white shadow-2xl
