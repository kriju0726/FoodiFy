        ...
        <div className='w-screen min-h-screen flex flex-col items-center gap-5 bg-[#fff9f6] overflow-y-auto'>
            <Nav/>
                <div className='w-full max-w-6xl flex flex-col gap-5 items-start p-[10px]'>
                    <h1 className='text-gray-800 text-2xl sm:text-3xl'>Inspiration For your First Orders</h1>
                    <div className='w-full relative'>
                        {showLeftCateButton && <button className='absolute left-0 top-1/2 -translate-y-1/2 bg-[#ff4d2d] text-white p-2 rounded-full 
                                                                  shadow-lg hover:bg-[#e64528] z-10' 
                                                                  onClick={() => scrollHandler(cateScrollRef, 'left')}>
                            <FaCircleChevronLeft />
                        </button>}
                        
                        <div className='w-full flex gap-4 pb-2 overflow-x-auto' ref={cateScrollRef}>
                ...
                <div className='w-full max-w-6xl flex flex-col gap-5 items-start p-[10px]'>
                    ...
                    <div className='w-full relative'>
                        ...
                        <div className='w-full flex gap-4 pb-2 overflow-x-auto' ref={shopScrollRef}>
